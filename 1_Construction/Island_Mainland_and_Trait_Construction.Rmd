---
title: "Island-Mainland Pairing and Trait Data Cross-Correlation"
...
```
 ...
 SAVE DATA
```{r}
saveRDS(sprich.pairwise, "data/GIFT_EFN_trait_data.RDS")
```
...
saveRDS(sprich.pairwise.ants, "data/GABI_efn_trait_data.RDS")
```
DEBUGGING
```{r}
